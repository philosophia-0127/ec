...
<head>
    ...
    <title>Asana Cake | @yield('title')</title>
</head>
...
<body>
    <header>
        <nav class="navbar navbar-expand-lg bg-secondary py-4 mb-4">
            ...
            <h3 class="row">
                <a href="{{ route('home.top') }}" class="title-logo text-light text-decoration-none ms-5">Asana Cake</a>
            </h3>
            ...
            <div class="collapse navbar-collapse" id="drop">
                <ul class="navbar-nav ms-auto">
                        ...
                        <a href="{{ route('home.about') }}" class="text-light text-decoration-none">
                            <li class="me-3">店舗詳細</li>
                        </a>
                        <a href="{{ route('product.index') }}" class="text-light text-decoration-none">
